...
│  │     network-probe worker/fixture + managed-job/browser-session owners are green,
│  │     but seven families keep G1 red; browser-session evidence is macOS-native, not Candidate
