# Archived pre-qjswasm v0.1.18 App Pack plan

> Superseded by `plan/plan-v0.1.18.md`. This snapshot assumed the removed QJS/Rh
> arrangement and is retained only as design history.
...
> 来源：[`archive/plan-v0.1.17.md`](plan-v0.1.17.md)，2026-08-12 归档时按
...
> 本节自 [`archive/plan-libagenterm.md`](plan-libagenterm.md) 全文合并（2026-08-12），
