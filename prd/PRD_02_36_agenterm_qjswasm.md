...
M0、编译器迁出、抬 rev 到 `049ebba`、接缝对抗审查、门落地、数组落地——六次同机同工具链的复测与两处「源码看着支持、编出来不支持」的记录，见 [归档](archive/PRD_02_36_agenterm_qjswasm_history_2026-08.md#历次复测)。**现行口径**只认「验证口径」一节的三条命令与「自验」表。
