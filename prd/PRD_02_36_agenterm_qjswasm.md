...
│  ├─ [x] Fleet and ACU bridge replies bill every returned byte into `host_bytes` on both success and application-error status paths; equal-size replies cost equally
