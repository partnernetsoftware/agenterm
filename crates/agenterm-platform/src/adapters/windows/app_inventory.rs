//! windows installed-application inventory: not wired in this cut.

use crate::contract::app_inventory::{AppInventoryError, InstalledApps};

/// Listing installed applications here means walking the Start Menu program folders and reading a
/// display name out of each entry, and launching one means the shell association.
