...
impl Executor {
    pub(super) fn run_current(
        ...
        match command {
            ...
            Command::ScreenReaderStatus { .. } => screen_reader_status_payload(),
            Command::KeyboardLayoutStatus { .. } => keyboard_layout_status_payload(),
            ...
            Command::ProcessorAffinityStatus { pid, .. } => processor_affinity_status_payload(*pid),
            ...
            Command::Hover {
                window, name, role, ..
            } => hover(*window, name.as_deref(), role.as_deref()),
            Command::SendText {
                text,
                window,
                name,
