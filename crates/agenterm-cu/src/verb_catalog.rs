//! Library-owned typed verb truth plus the compressed, immutable cold help catalog.
//!
...
//! projections. CLI parsing and persisted-grant validation share this table;
//! ordinary dispatch never inflates or parses the cold catalog.
...
mod tests {
    ...
    fn scopes_follow_the_command_contract() {
        ...
        assert_eq!(actuate.len(), 115, "{actuate:?}");
    }
}
