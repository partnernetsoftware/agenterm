(module
  ...
  (memory 1)
  (data (i32.const 0) "libSystem.B.dylib|getentropy|i32(ptr,u64)")
  (func (export "main") (result i64)
    ...
    (i64.store (i32.const 168) (i64.const 16))
    (drop (call $native_call (i32.const 0) (i32.const 41) (i32.const 128) (i32.const 48)))
