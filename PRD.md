...
│     │                       typed 调用执行。95 条动态 witness 的 27 条 resolved 已全部清账：
│     │                       14 exec + 8 compound + 5 usage；6 条 dynamic-stay witness 继续按稳定
...
flowchart LR
  ...
  ACUQJS["agenterm cli acu [~]<br/>embedded · Bun-free · any cwd<br/>42/42 positive · 27 resolved · 6 TODO"]
