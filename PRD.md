...
│     │                       Unix xattr set/remove 与 macOS quarantine-clear 已有同一零写/身份/
│     │                       前值/读回门；公开结果与审计仅留长度+摘要，macOS qjswasm 已绿
...
│     │                       persisted grant schema 3 已冻结 canonical operation；旧 schema 2
...
│  │                          typed owners 与六格 facts/catalog/evidence 属迁移债
│  │                          （迁上层/产品层）；ISA folding / wasm export / libagenterm
│  │                          merge 仍未授权
