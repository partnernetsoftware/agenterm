...
```text
page-find [--port N] (--target-id ID | --target-url SUB | --target-title SUB)
...
```text
page-click [--port N] (--target-id ID | --target-url SUB | --target-title SUB)
...
```text
page-fill [--port N] (--target-id ID | --target-url SUB | --target-title SUB)
...
```text
page-nav [--port N] (--target-id ID | --target-url SUB | --target-title SUB) --url URL [--wait-ms N]
...
```text
page-screenshot [--port N] (--target-id ID | --target-url SUB | --target-title SUB) --out PATH [--replace] [--activate]
...
```text
page read [--js EXPR] | page targets | page text | page find | page click | page fill | page nav | page screenshot
